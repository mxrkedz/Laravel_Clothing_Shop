...
<div class="row">
        <div class="col-12 table-responsive">
            <div align="left"><a href="{{route('category.create')}}" class="btn btn-primary btn-lg float-start" role="button" aria-disabled="true" style="margin-right: 15px;">Create New</a>
...
<br>
        <form action="{{url('category/import')}}" method="post" enctype="multipart/form-data">
            ...
            <table class="table" width="auto">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src="{{$category->img_path}}" class="img-thumbnail" width="100" height="100" ></td>
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="min-width: 100px;">
        <a class="dropdown-item" href="{{route('category.edit',$category->id)}}"><i class="fas fa-edit fa-lg" style="color: #FFAE42;"></i> Edit</a>
        <form style="margin-bottom: 0;" action="{{route('category.destroy',$category->id)}}" method="POST">
            @method('DELETE')
            @csrf
        ...
        </div> <!-- Close the <div class="card-body"> -->
    </div> <!-- Close the <div class="card"> -->
</div> <!-- Close the main container <div class="container-xxl"> -->
@endsection
