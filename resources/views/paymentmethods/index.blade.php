...
<div class="row">
        <div class="col-12 table-responsive">
            <div align="left"><a href="{{route('paymentmethods.create')}}" class="btn btn-primary btn-lg float-start" role="button" aria-disabled="true" style="margin-right: 15px;">Create New</a>
...
<br>
        <form action="{{url('paymentmethods/import')}}" method="post" enctype="multipart/form-data">
                       @csrf
                       <fieldset>
