...
<!-- For Dropdown -->
@section('active_menu', 'paymentmethods')
@section('active_menu', 'manage')

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
<h4 class="fw-bold py-3 mb-4">Manage <span class="text-muted fw-light">/ Payment Methods</span></h4>
    <div class="card">
        <div class="card-body">   
...
<table class="table" width="auto">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="min-width: 100px;">
                    <a class="dropdown-item" href="{{route('paymentmethods.edit',$payment->id)}}"><i class="fas fa-edit fa-lg" style="color: #FFAE42;"></i> Edit</a>
                    <form style="margin-bottom: 0;" action="{{route('paymentmethods.destroy',$payment->id)}}" method="POST">
                        @method('DELETE')
                        @csrf
